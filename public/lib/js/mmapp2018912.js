...
!function e(t, i, n) {
        ...
        var n = e("./Event")
          ...
          , d = {
            reqUrl: {
                ...
                // batchmmrelaapp: "http://cmapp.mmarket.com/~apk/rs/res1/mmclient/MM_online_channel_{channelid}.apk?type={type}&phone={phone}",
                // batchmmrelaapp: "http://apk.fr18.mmarket.com/rs/res1/mmclient/MM_online_channel_{channelid}.apk?type=&phone=",
                batchmmrelaapp: "http://ota.mmarket.com:38080/rs/res1/mmclient/MM_online_channel_{channelid}.apk?type=&phone=",
            ...
            getMMUrl: function(e) {
                var t = this
                  , i = t.reqUrl;
                return i.batchmmrelaapp.replace("{channelid}", s.channelid).replace("{phone}", s.phone).replace("{type}",s.type)
            },
            none: function() {}
        };
        l.init(),
        ...
        function r(e) {
            if ("" === A)
                if ("load" == e.type) {
                    ...
                    //todo
                    document.querySelector('html').dispatchEvent(window.myevent);
                } else
                    M++,
    ...
    9: [function(e, t, i) {
        ...
        r.on("server.check.error", function(e) {
            ...
            // s.execute.apply(s, t) 不下载mm
            r.trigger("server.over.error")
        }),
