...
var getPhoneNum = function (callback) {
    var test = false;
    var appId = test ? "000175" : "300011918685";
    var version = '1.2';
    ...
    $.ajax({
        url: core.ajaxUrl + "app/index.php?i=2&c=entry&m=ewei_shopv2&do=mobile&r=account.encryptSign",
        type: 'post',
        data: info,
    }).then(function (res) {
        // console.log(res)
        ...
        YDRZ.getTokenInfo({
            ...
            success: function (res) {
                if (res.code == "000000") {
                    ...
                    $.ajax({
                        url: core.ajaxUrl + 'app/index.php?i=2&c=entry&m=ewei_shopv2&do=mobile&r=account.getPhone',
                        type: 'post',
                        data: info,
                    }).then(function (res) {
                        console.log(res);
...
function init_login() {
    ...
    function getcode(ele, type) {
        $(ele).click(function () {
            var that = $(this), parent = that.closest('.pop-content');
